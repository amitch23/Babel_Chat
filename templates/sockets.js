...
//---------handles card games and game moves-----------------------
    ...
    //requests next card from server and increase counter by 1
...
//-----------ever-present btn handlers/misc.-----------------------
    ...
    //alert and leave room for user who clicks end_session_btn
    ...
    //display alert to user who was disconnected with (see above)
...
//-----------chat box handlers-----------------------
    ...
    //if user hits enter in addition to click, run above function
